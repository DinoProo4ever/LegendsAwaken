...
public class ExtractingCategory implements DisplayCategory<Display> {
    public static final Identifier TEXTURE = Identifier.of(LegendsAwaken.MOD_ID,
            "textures/gui/container/dna_extractor_rei.png");

    public static final CategoryIdentifier<ExtractingDisplay> EXTRACTING =
            CategoryIdentifier.of(LegendsAwaken.MOD_ID, "extracting");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(JurassicBlocks.DNA_EXTRACTOR);
    }
