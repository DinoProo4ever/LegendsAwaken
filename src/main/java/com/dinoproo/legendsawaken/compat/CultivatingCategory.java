...
public class CultivatingCategory implements DisplayCategory<Display> {
    public static final Identifier TEXTURE = Identifier.of(LegendsAwaken.MOD_ID,
            "textures/gui/container/cultivator_rei.png");

    public static final CategoryIdentifier<ExtractingDisplay> CULTIVATING =
            CategoryIdentifier.of(LegendsAwaken.MOD_ID, "cultivating");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(JurassicBlocks.CULTIVATOR);
    }
    ...
    public List<Widget> setupDisplay(Display display, Rectangle bounds) {
        ...
        widgets.add(Widgets.createSlot(new Point(startPoint.x + 54, startPoint.y + 24))
                .entries(display.getInputEntries().get(0)).disableBackground().markInput());
        widgets.add(Widgets.createSlot(new Point(startPoint.x + 54, startPoint.y + 44))
