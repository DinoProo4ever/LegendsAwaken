...
import com.dinoproo.legendsawaken.jurassic.block.entity.custom.*;
...
public class JurassicBlockEntities {
    ...
    public static final BlockEntityType<FenceGateBlockEntity> FENCE_GATE_BE =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(LegendsAwaken.MOD_ID,"low_security_fence_gate_be"),
