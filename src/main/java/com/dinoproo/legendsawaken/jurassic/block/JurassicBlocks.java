...
public class JurassicBlocks {
    ...
    public static final Block FENCE_GATE = Registry.register(
            Registries.BLOCK, Identifier.of(LegendsAwaken.MOD_ID, "fence_gate"),
            new FenceGateBlock(AbstractBlock.Settings.create().strength(12F).nonOpaque().requiresTool().sounds(BlockSoundGroup.METAL))
    );
    public static final Item FENCE_GATE_ITEM = Registry.register(
            Registries.ITEM, Identifier.of(LegendsAwaken.MOD_ID, "fence_gate"),
            new FenceGateBlockItem(FENCE_GATE, new Item.Settings())
    );
