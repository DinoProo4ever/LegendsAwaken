...
public class CultivatorScreen extends HandledScreen<CultivatorScreenHandler> {
    private static final Identifier GUI_TEXTURE =
            Identifier.of(LegendsAwaken.MOD_ID, "textures/gui/container/cultivator.png");
    private static final Identifier ARROW_TEXTURE =
            Identifier.of(LegendsAwaken.MOD_ID, "textures/gui/arrow_progress.png");

    private static final Identifier SYNTETIC_EGG =
            Identifier.of(LegendsAwaken.MOD_ID, "textures/gui/slot/syntetic_egg.png");
    ...
    private void renderGrayItems(DrawContext context, int x, int y) {
        if (handler.getSlot(0).getStack().isEmpty()) {
            context.drawTexture(SYNTETIC_EGG, x + 54, y + 24, 0, 0, 16, 16, 16, 16);
        }
