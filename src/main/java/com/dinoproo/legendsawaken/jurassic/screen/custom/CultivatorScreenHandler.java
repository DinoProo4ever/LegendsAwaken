...
public class CultivatorScreenHandler extends ScreenHandler {
    ...
    public CultivatorScreenHandler(int syncId, PlayerInventory inventory, BlockPos pos) {
