...
public class DNAHybridizerScreen extends HandledScreen<DNAHybridizerScreenHandler> {
    private static final Identifier GUI_TEXTURE =
            Identifier.of(LegendsAwaken.MOD_ID, "textures/gui/container/dna_hybridizer.png");
    ...
    public DNAHybridizerScreen(DNAHybridizerScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    private void renderDNAProgress(DrawContext context, int x, int y) {
        if(handler.isCrafting()) {
            ...
            context.drawTexture(DNA_PROGRESS_LEFT_TEXTURE, x + 34, y + 31, 0, 0,
                    width, 24, 41, 24);
            context.drawTexture(DNA_PROGRESS_RIGHT_TEXTURE, x + 152 - width, y + 31, 0, 0,
                    width, 24, 41, 24);
        }
    }
