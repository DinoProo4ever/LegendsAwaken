...
public class DNAExtractorScreen extends HandledScreen<DNAExtractorScreenHandler> {
    private static final Identifier GUI_TEXTURE =
            Identifier.of(LegendsAwaken.MOD_ID, "textures/gui/container/dna_extractor.png");
